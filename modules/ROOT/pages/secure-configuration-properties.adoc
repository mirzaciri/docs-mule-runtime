...
Download link: https://docs.mulesoft.com/downloads/mule-runtime/4.2/secure-properties-tool.jar[Secure Properties Tool Jar file]. +
Latest release: 04/15/2021.
...
https://secure-properties-api.us-e1.cloudhub.io[There is also an online tool for encrypting and decrypting text strings]
